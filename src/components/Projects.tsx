    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-14 grid gap-6 lg:grid-cols-2">
          ...
          {/* Project 1 */}
          <article className="group rounded-3xl border border-white/10 bg-white/[0.03] p-7 transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] md:p-8">
            ...
            <p className="mt-5 leading-7 text-zinc-400">
              ...
              Covers core programming, databases, cloud platforms, distributed
          ...
          <article className="group rounded-3xl border border-white/10 bg-white/[0.03] p-7 transition duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-white/[0.05] md:p-8">
            ...
            <p className="mt-5 leading-7 text-zinc-400">
              ...
              stores and manages analytical datasets, and visualizes market
              trends for downstream analysis.
            </p>
          ...
          {/* Future Project */}
          <article className="rounded-3xl border border-dashed border-white/10 bg-white/[0.02] p-7 md:p-8 lg:col-span-2">
