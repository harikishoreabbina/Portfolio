        ...
        <section className="px-6 py-24 md:px-12 lg:px-20">
          <div className="mx-auto w-full min-w-0 max-w-6xl">
            ...
            <div className="mt-12">
              ...
              <h1 className="mt-5 break-words text-4xl font-bold md:text-6xl">
              ...
              <div className="mt-10">
                <a
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-white px-6 py-3 font-semibold text-black transition duration-300 hover:scale-105"
                >
                  <FaGithub size={20} />
                  View GitHub
            ...
            <div className="mt-24 border-t border-white/10 pt-16">
              ...
              <div className="mt-8 grid gap-10 lg:grid-cols-2">
                ...
                <p className="leading-8 text-zinc-400">
                  ...
                  assignments, and project work so the learning path progresses
                  from fundamentals into practical engineering workflows.
                </p>
              </div>
            </div>
            ...
            <div className="mt-24 border-t border-white/10 pt-16">
              ...
              <div className="mt-10 overflow-hidden rounded-3xl border border-white/10 bg-white/[0.03] p-6 md:p-8">

                {/* Desktop */}
                <div className="hidden gap-4 text-center md:grid md:grid-cols-7">
                ...
                <div className="flex flex-col items-center gap-4 text-center md:hidden">
                  <div className="w-full rounded-xl border border-white/10 p-5">
                    Topic
                  </div>
            ...
            <div className="mt-24 border-t border-white/10 pt-16">
              ...
              <div className="mt-8 grid gap-10 lg:grid-cols-2">
                ...
                <p className="leading-8 text-zinc-400">
                  ...
                  concepts into a practical learning path rather than treating
                  individual technologies as isolated topics. The goal is to
                  connect programming, SQL, cloud platforms, orchestration,
                  distributed processing, CI/CD, and hands-on projects into one
